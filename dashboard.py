...
#the Q&A on the dashboard page has to be saved as full html
# this script is then run from the same directory the html was saved in via terminal:  python dashboard.py
